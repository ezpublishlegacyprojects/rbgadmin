...
<div id="logo">
<img src={'ezpublish-logo-4-symbol.gif'|ezimage} width="150" height="20" alt="eZ Publish" border="0" />
...
<form action={'/content/search/'|ezurl} method="get">
    ...
    {section-else}
        ...
        {/section}
    {/section}
 <label{section show=$disabled} class="disabled"{/section}><select name="SubTreeArray" id="1">
    <option value="1">{'All content'|i18n( 'design/admin/pagelayout' )}</option>
    <option value="{$nd}">{section show=$current_loc}{'Current location'|i18n( 'design/admin/pagelayout' )}{section-else}{'The same location'|i18n( 'design/admin/pagelayout' )}{/section}</option>
  </select>
  </label>
    {/let}
    </p>
